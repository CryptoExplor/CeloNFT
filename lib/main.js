...
async function initializeApp() {
  try {
    ...
    // Show external banner if in Farcaster
    if (isFarcasterEnvironment && externalBanner) {
      externalBanner.classList.add('show');
      externalBanner.classList.remove('pulse'); // Remove any existing pulse class
      ...
      console.log('✅ External banner shown');
    }
...
// FIX: Load leaderboard - IMPROVED VERSION
...
// FIX: Show transaction links after mint
...
// Initialize TradingView - FIX: This was never called!
